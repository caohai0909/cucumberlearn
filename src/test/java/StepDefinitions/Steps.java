...
public class Steps {
    ...
    public void user_go_to_login_page() {
        System.out.println("User go to login page _ Test pull request 10:11");
    }
    @When("User enter valid information")
    public void user_enter_valid_information() {
        System.out.println("User enter valid information _ Test pull request 10:11");
    }
    @When("User click to submit")
    public void user_click_to_submit() {
        System.out.println("User click to submit _ Test pull request 10:11");
    }
